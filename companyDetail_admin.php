...
echo "<table  class='table' style='width:auto;'><tr class='danger'><th>Department</th><th>Description</th><th>Eligibility</th><th>Internship start</th><th>Internship end</th><th>Application start</th><th>Application end</th><th>Needed number</th><th>Application Limit</th><th>Action<th></tr>";
while($row=mysqli_fetch_array($b))
{

echo "<tr><td>".$row['department_name']."</td><td>".$row['description']."</td><td width='300px'>".$row['eligibility']."</td><td>".$row['start']."</td><td>".$row['end']."</td><td>".$row['application_start']."</td><td>".$row['application_end']."</td><td>".$row['needed_number']."</td><td>".$row['application_limit']."</td><td><a href='updatedepartment.php?internship_id=".$row['internship_id']."' class='btn btn-info' role='button'>Update</a></td><td><a href='deletedepartment.php?internship_id=".$row['internship_id']."' class='btn btn-danger' role='button'>Delete</a></td></tr>";
}
echo "</table>";
?>
		</div>
