        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link   active" href="application_applicant.php">Application</a>
					</li>
					<li class="nav-item">
...
echo "</table></center>";
echo "<center><a href='applicationForm.php' class='btn btn-primary' role='button'>Apply Now</a><a href='application_applicant.php' class='btn btn-success' role='button'>Back</a></center>";
?>
